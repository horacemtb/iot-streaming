...
Each device collected seven different sensor readings at regular intervals. Six of these readings were used in this project: temperature, humidity, carbon monoxide (CO), liquid petroleum gas (LPG), smoke, and light. The "motion" variable was excluded due to zero variance in the data. The data covers the period from 07/12/2020 00:01:00 UTC to 07/19/2020 23:59:59 UTC.
