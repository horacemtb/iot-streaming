...
- Группирет данные по минутам и вычисляет средние значения всех переменных.
...
5. Бизнес-аналитика и визуализация в Metabase

- Metabase подключается к PostgreSQL, что позволяет напрямую обращаться к таблицам DataMart для запросов и визуализации.
